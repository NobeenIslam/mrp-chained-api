...
export const CHAINED_JOB_DURATION_SECONDS = 5;
export const CHAINED_MAX_DURATION = 15;

// Sequential route: 4 jobs × 6s = 24s total in one invocation (maxDuration=20s)
// Vercel will kill this before completion
export const SEQUENTIAL_JOB_DURATION_SECONDS = 6;
export const SEQUENTIAL_MAX_DURATION = 20;

// Race route: Same as sequential but with graceful timeout at 15s
export const RACE_TIMEOUT_SECONDS = 15;
